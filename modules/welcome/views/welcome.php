<section>
    <h1 class="text-center blink">Welcome To Club DC!</h1>
    <h2 class="mt-1">Welcome to the club - where secrets flow out and money flows in.</h2>
    <p class="text-center lg">
        <?php
        echo anchor('members/create_account', 'Create Account', array('class' => 'button'));
        echo anchor('members/login', 'Member Login', array('class' => 'button alt'));
        ?>
    </p>
</section>
